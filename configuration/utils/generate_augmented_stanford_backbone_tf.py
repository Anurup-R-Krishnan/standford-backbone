...
for replicate in range(replication_factor):
    ...
    rule = TF.create_standard_rule(
        [out_port + bbra_cs.PORT_TYPE_MULTIPLIER * bbra_cs.OUTPUT_PORT_TYPE_CONST],
        None,
        [root_port],
        None,
        None,
    ...
    rule = TF.create_standard_rule(
        [root_port + bbra_cs.PORT_TYPE_MULTIPLIER * bbra_cs.OUTPUT_PORT_TYPE_CONST],
        None,
        [out_port],
        None,
        None,
    ...
    for from_router, from_port, to_router, to_port in topology:
        ...
        rule = TF.create_standard_rule(
            [
                ...
                + from_cs.PORT_TYPE_MULTIPLIER * from_cs.OUTPUT_PORT_TYPE_CONST
            ],
            None,
...
for port in root_tf_ports:
    ...
    r = TF.create_standard_rule(
        [port + dummy_cs.PORT_TYPE_MULTIPLIER * dummy_cs.INTERMEDIATE_PORT_TYPE_CONST],
        byte_array_get_all_x(dummy_cs.HS_FORMAT()["length"] * 2),
