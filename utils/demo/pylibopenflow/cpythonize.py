...
class pythonizer:
    ...
    def codepack(self, struct_in, prefix="!"):
        ...
        for member in struct_in.members:
            if isinstance(member, cheader.cprimitive):
                ...
                (primPattern, primMemberNames) = self.__codepackprimitive(
                    code, primPattern, primMemberNames, prefix
                )
                if isinstance(member, cheader.cstruct):
                    # Struct
                    code.append(
                ...
                elif isinstance(member, cheader.carray) and isinstance(
    ...
    def codeunpack(self, struct_in, prefix="!"):
        ...
        for member in struct_in.members:
            if isinstance(member, cheader.cprimitive):
                ...
                (primPattern, primMemberNames, offset) = self.__codeunpackprimitive(
                    code, offset, primPattern, primMemberNames, prefix
                )
                if isinstance(member, cheader.cstruct):
                    # Struct
                    code.append(
    ...
    def __codeunpackprimitive(self, code, offset, primPattern, primMemberNames, prefix):
