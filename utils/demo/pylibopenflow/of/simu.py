...
class switch(ofnetwork.switch):
    ...
    def send_echo(self, xid=0):
        ...
        self.connection.structsend_xid(
            "ofp_header", 0, self.__messages.get_value("OFPT_ECHO_REQUEST"), 0, xid
        )
    ...
    def reply_echo(self, xid):
        ...
        self.connection.structsend_xid(
            "ofp_header", 0, self.__messages.get_value("OFPT_ECHO_REPLY"), 0, xid
        )
    ...
    def reply_features(self, xid):
        ...
        self.connection.structsend_xid(
            "ofp_switch_features",
            0,
            self.__messages.get_value("OFPT_FEATURES_REPLY"),
            0,
            xid,
            self.datapath_id,
            self.n_buffers,
    ...
    def reply_stats(self, xid):
        ...
        pkt = self.__messages.pack(
            "ofp_stats_reply",
            0,
            self.__messages.get_value("OFPT_STATS_REPLY"),
            0,
            xid,
            0,
            0,
    ...
    def reply_get_config(self, xid):
        ...
        self.connection.structsend_xid(
            "ofp_switch_config",
            0,
            self.__messages.get_value("OFPT_GET_CONFIG_REPLY"),
            0,
            xid,
            0,
            0xFFFF,
